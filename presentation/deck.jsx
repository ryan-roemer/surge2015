...
import Interactive from "spectacle/presentation/interactive";

const images = {
  city: require("spectacle/presentation/city.jpg"),
  kat: require("spectacle/presentation/kat.png"),
    ...
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={800}>
        ...
        <Slide transition={['zoom', 'fade']} bgColor="primary" notes="<ul><li>talk about that</li><li>and that</li></ul>">
          <CodePane
            lang="javascript"
            source={require("raw!spectacle/presentation/deck.example")}
            margin="20px auto"/>
        </Slide>
